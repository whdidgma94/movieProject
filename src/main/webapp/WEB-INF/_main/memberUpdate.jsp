...
<body class="mainView">
	...
	<form action="${ctx}/memberUpdate.do" method="post" id="form">
		<table>
			<tr>
				<th>이름</th>
				<td> <input type="text" value="${member.memberName}" name="memberName"/>  </td>
				<td></td>
			</tr>
			<tr>
				<th>비밀번호</th>
			...
			<tr> 
			  ...
			  <td>
			    ...
			    <input type="button" onclick="showAddressForm()" value="주소변경" id="addressBtn">
			  </td>
			</tr>
			<tr>
				<th>이메일</th>
				<td>
				  <div class="email-wrapper">
				    ...
				    <input type="text" name="email_domain" placeholder="도메인"/> 
			...
			<tr> <td colspan="3"><input type="button" onclick="updateBtn()" value="변경"></td> </tr>
		</table>
	</form>
</body>
<script>
